        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
          ...
          <div className="space-y-6">
            ...
            <p className="text-gray-500 text-[11px] font-bold uppercase tracking-widest leading-loose max-w-70">
              Direct processing bridge for Qatar and Bangladesh. 24/7
              specialist-led visa infrastructure.
            </p>
            <div className="flex gap-4">
              {[Linkedin, Twitter, Instagram].map((Icon, i) => (
                <Link
                  key={i}
                  href="#"
                  className="h-9 w-9 rounded-lg border border-white/5 flex items-center justify-center text-gray-500 hover:text-white hover:border-white/20 transition-all"
                >
                  <Icon size={16} />
                </Link>
              ))}
